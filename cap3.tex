...
El Makefile se encarga de compilar, enlazar y empaquetar la biblioteca core en el archivo \programa{core.a} y luego compila todos los archivos en la carpeta \programa{lib} y la carpeta{src}. Una vez enlazado podemos usar la orden \comando{make load} para cargar el programa en la placa.
