...
\begin{enumerate}
    \item Analizar el proceso de compilación del MPIDE.
...
En la sección~\ref{sec:compilacion} se desarrolla el primero de los objetivos de este trabajo, que ha sido alcanzado con éxito.

El segundo objetivo llevó más trabajo al necesesitar crear un programa específico con el que se pudiesen realizar las mediciones. Una vez hecho esto, se realizaron las mediciones y se completó el segundo de los objetivos. Todo el proceso está descrito a lo largo de las primeras secciones del capítulo~\ref{cap4}.
