...
Para poder averiguar qué optimizaciones lleva acabo el compilador en un determinado nivel de optimización podemos emplear la órden \orden{pic32-gcc -OX -Q --help=optimizers | grep enabled}, sustituyendo \orden{X} por el nivel que queramos. Esta orden muestra todas las posibles optimizaciones, indicando si están habilitadas o no; y para ver solo las habilitadas pasamos el resultado a \orden{grep}, para filtrarlas.
