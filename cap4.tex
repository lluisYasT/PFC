...
\begin{table}[htb]
	\begin{center}
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			Método	&		Cuentas		&		Ciclos	&		Periodo		&		Frecuencia \\
			\hline
			\hline
			Arduino	&		5763684		&		11527368&		1.44 us		&		694 kHz \\
			\hline
			Registros&	501040		&		1002080	&		125.26 ns	&		7.98 MHz \\
			\hline

		\end{tabular}
	\end{center}
	\caption{Resultados del primer método}
	\label{ard_vs_reg:1}
\end{table}
