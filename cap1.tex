...
En 1971 Intel creó el primer microcontrolador de la histora: el intel 4004 de 4 bits. Desde entonces, los microcontroladores han ido evolucionando hasta los modelos de hoy en día. En la actualidad existen multitud de modelos diferentes entre los que elegir. Su arquitectura puede ser diferente dependiendo del fabricante o, dentro de este, de la gama. Por ejemplo, Microchip utiliza una arquitectura para su gama de 32 bits diferente al resto de gamas más bajas.
