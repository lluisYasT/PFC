...
MIPS fue desarrollada por John L. Hennessy y su equipo como una arquitectura de tipo RISC de 32 bits. Al igual que AVR, MIPS cuenta con segmentación de instrucciones, pero dividido en cinco etapas mostradas en la figura \ref{mipspipeline}.
