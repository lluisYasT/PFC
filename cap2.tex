...
\comando{array\_aleatorio} simplemente rellena \comando{array\_numeros} con números aleatorios entre 0 y \(2^{31}\).

\lstinputlisting[firstline=298, breaklines=true]{codigo_fuente/sketch.cpp}
En \comando{compara} generamos un array con números aleatorios y ejecutamos todos los algoritmos de ordenación sobre el mismo array. De esta forma podemos compararlos con un solo comando.