...
En este capitulo analizaré las características del Arduino Mega y del ChipKIT MAX32, que es el equivalente en chipKIT, tanto en formato y dimensiones como en precio.
...
\end{tabular}
\end{center}
\caption{Especificaciones de Arduino Mega.}
...
El otro shield que usaré será el ChipKIT Basic I/O Shield que nos servirá para interactuar físicamente con el microcontrolador ya que este shield nos proporciona diferentes métodos de entrada y salida de información así como conectores de utilización más sencilla y robusta.
