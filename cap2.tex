...
\begin{itemize}
	\item \negrita{bin}. Aquí se guardarán el programa compilado y enlazado.
	\item \negrita{core}. Aquí está la biblioteca Arduino junto con los archivos de cabecera de las diferentes placas disponibles, en la carpeta ``variants''
	\item \negrita{lib}. Aquí se colocarán las bibliotecas de terceros de la misma forma que en MPIDE: copiando la carpeta de la biblioteca en este directorio.
	\item \negrita{src}. Aquí estará el código fuente del programa que hayamos creado.
\end{itemize}
Tanto en la carpeta principal como en \programa{core} y \programa{lib} tendremos un archivo Makefile para la automatización de los procesos de compilación, ensablado y posterior carga de nuestro programa.\\
Makefile principal:
