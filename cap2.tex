...
MPIDE es un entorno de desarrollo sencillo, con el que podemos escribir nuestro programa, compilarlo y cargarlo en nuestro microcontrolador. Al igual que el entorno de Arduino, no es posible depurar programas, para eso usaremos MPLAB X. También dispone de un monitor para el puerto serie, con el que podemos leer lo que el microcontrolador envía a través de este puerto y enviar información al microcontrolador.
\subsection{MPLAB X}
