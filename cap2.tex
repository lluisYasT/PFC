...
La unidad de administración de memoria utiliza un mecanismo FMT (Fixed Mapping Tranlation) que es más simple y pequeño que el mecanismo TLB (Tranlation Lookaside Buffer) que puede se puede encontrar en otros núcleos MIPS. Al igual que hace el TLB, FMT realiza la conversión entre direcciones virtuales y direcciones físicas y proporciona atributos para los diferentes segmentos de memoria.
