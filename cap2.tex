...
En cualquier programa para Chipkit o Arduino podemos encontrar tres grupos principales de código fuente. Para empezar, tenemos los archivos que formarán parte de la biblioteca ``Core'' a la hora de la compilación, que vienen incluidos con MPIDE y los podemos encontrar en el directorio en el que tengamos instalado MPIDE, en la subcarpeta:\\
\comando{hardware/pic32/cores/pic32}
En esta biblioteca está ya definida la función main de nuestro programa y tiene el siguiente aspecto:
%\lstinputlisting{codigo/main.cpp}
\begin{lstlisting}
...
\end{lstlisting}
Cuando escribimos un programa usando MPIDE, lo que realmente hacemos es definir las funciones setup y loop.
