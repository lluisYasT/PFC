...
\begin{itemize}
	...
	\item \comando{copia\_a\_resultado} copia el contenido de la variable array a resultado, para que las funciones de ordenación modifiquen solamente esta última variable.
	\item \comando{deco\_comando} devuelve el comando (un dato de tipo `comandos') en función del array \comando{comando} que contiene el comando extraído directamente del mensaje.
	\item \comando{ejecuta\_comando} ejecuta el comando seleccionado anteriormente.
\end{itemize}
